...
function usePickerState(props, options) {
    var autoOk = props.autoOk, disabled = props.disabled, onAccept = props.onAccept, onChange = props.onChange, onError = props.onError, value = props.value, variant = props.variant;
    var utils = useUtils_1.useUtils();
    ...
    var inputProps = react_1.useMemo(function () { return ({
        ...
        onClick: function () { return !disabled && setIsOpen(true); },
