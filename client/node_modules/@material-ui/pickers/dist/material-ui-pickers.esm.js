...
import React__default, { createContext, useMemo, createElement, useContext, useCallback, cloneElement, useEffect, useLayoutEffect, useRef, Fragment, Component, useState, forwardRef, memo, useDebugValue } from 'react';
...
import { makeStyles as makeStyles$1, IconButton as IconButton$1, Grid } from '@material-ui/core';
...
var getOrientation = function () {
  return typeof window !== 'undefined' && window.screen && window.orientation && Math.abs(window.screen.orientation.angle) === 90 ? 'landscape' : 'portrait';
};
...
var Picker = function (props) {
  ...
  var _c = useViews(views, openTo, onChange),
      openView = _c.openView,
      setOpenView = _c.setOpenView,
      handleChangeAndOpenNext = _c.handleChangeAndOpenNext;
...
var KeyboardDateInput = function (_a) {
  var inputValue = _a.inputValue,
      ...
      other = __rest(_a, ["inputValue", "inputVariant", "validationError", "KeyboardButtonProps", "InputAdornmentProps", "onClick", "onChange", "InputProps", "mask", "maskChar", "refuse", "format", "keyboardIcon", "disabled", "rifmFormatter", "TextFieldComponent"]);
