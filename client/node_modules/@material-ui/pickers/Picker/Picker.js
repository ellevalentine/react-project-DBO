...
var viewsMap = {
    ...
    hours: ClockView_1.TimePickerView,
    minutes: ClockView_1.TimePickerView,
    seconds: ClockView_1.TimePickerView,
};
...
exports.Picker = function (props) {
    ...
    return (React.createElement("div", { className: clsx_1.default(classes.container, (_a = {},
        ...
        React.createElement("div", { className: clsx_1.default(classes.pickerView, (_b = {}, _b[classes.pickerViewLandscape] = isLandscape, _b)) },
            ...
            (openView === 'hours' || openView === 'minutes' || openView === 'seconds') && (React.createElement(ClockView_1.TimePickerView, { date: date, ampm: ampm, type: openView, minutesStep: minutesStep, onHourChange: handleChangeAndOpenNext, onMinutesChange: handleChangeAndOpenNext, onSecondsChange: handleChangeAndOpenNext })))));
};
