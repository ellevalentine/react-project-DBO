class TransactionsController < ApplicationController
    ...
    def allTransactionsByCategory
        ...
        bills_total = category_spending['bills']
        subscriptions_total = category_spending['subscriptions']
        food_total = category_spending['food']
        travel_total = category_spending['travel']
        phone_total = category_spending['phone']
        holiday_total = category_spending['holiday']
        retail_total = category_spending['retail']
        tech_total = category_spending['tech']
        other_total = category_spending['other']
