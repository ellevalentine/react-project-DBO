...
var CarouselSlide = function CarouselSlide(props) {
  ...
  return React__default.createElement(
    ...
    React__default.cloneElement(children, { focused: focused })
  );
};
...
var CarouselSlide$1 = core.withStyles(styles)(CarouselSlide);
...
var Dots$1 = core.withStyles(styles$1)(Dots);
  ...
  function Carousel() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (Math.abs(swipe) > 5) {
        ...
        var max = React__default.Children.count(children) - 1;
      ...
      return React__default.cloneElement(slide, {
        focused: i === focused,
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.Children.map(children, this.renderSlide)
            )
          )
        ),
        React__default.createElement(
          'div',
          { className: classes.dots },
          React__default.createElement(Dots$1, {
            index: focused,
...
var Carousel$1 = core.withStyles(styles$2)(Carousel);

exports.Carousel = Carousel$1;
exports.CarouselSlide = CarouselSlide$1;
